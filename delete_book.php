...
<html lang="en">
  ...
  <header>
    ...
    <a href="#" class="active bg-success">Delete Book</a>
...
<div class="container">
    <form class="p-4 m-4"  method="post" action="delete_book_action.php">
    <h1 class="text-success p-4 m-5"> Delete Book </h1>
    ...
    <thead>
        ...
        <?php foreach ($book as $i => $item) : //how to iterate?> 
            ...
            <td>
                    ...
                    <button type="submit" name="id" value="<?php echo $item['id'] ?>" class="btn bg-success text-white btn-outline-success">Delete Book</button>
                    </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
